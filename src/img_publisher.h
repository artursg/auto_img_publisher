#ifndef IMG_PUBLISHER
#define IMG_PUBLISHER
...
class Img_stream {
    ...
    std::string default_path = ros::package::getPath("img_publisher") + "test/";
    std::vector<cv::String> fn;
    bool load_img(std::string path, std::string filter, std::vector<cv::Mat> &images);
